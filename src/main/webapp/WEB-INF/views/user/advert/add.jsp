	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<div class="row">
					<div class="container-fluid" id=" header-breadcrumb">
			...
			<div class="card-body">
				...
				<s:form method="post" modelAttribute="advert"
					action="${pageContext.request.contextPath}/admin/advert/add" id="addAdvertForm"
					...
					<div id="step-1">
						...
						<div class="row mb-5">
							<div class="table-responsive pad" id="category-select-table">
								<table class="table table-responsive">
									<tbody>
										<tr id="category-table-tr">
											<td>
												<div class="btn-group-vertical m-2 p-2 border" id="parentCatCont">
													<c:forEach var="c" items="${parentCats}">
														<a class="btn-info category-table-button"															
															onclick="selectCategory('${c.id}'); selectCategoryButton(this);">${c.name}</a>
													</c:forEach>
												</div>
											</td>
										</tr>
							...
							<div class="col-2" id="sub1">
								<select class="custom-select" name="sub1Cat" id="sub1Cat" size="${parentCats.size()}">
								</select>
							</div>
							<div class="col-2" id="sub2">
								<select class="custom-select" name="sub2Cat" id="sub2Cat" size="${parentCats.size()}">
								</select>
							</div>
							<div class="col-2" id="sub3">
								<select class="custom-select" name="sub3Cat" id="sub3Cat" size="${parentCats.size()}">

								</select>
							</div>
							<div class="col-2" id="sub4">
								<select class="custom-select" name="sub4Cat" id="sub4Cat" size="${parentCats.size()}">

								</select>
							</div>
							<div class="col-2" id="sub5">
								<select class="custom-select" name="sub5Cat" id="sub5Cat" size="${parentCats.size()}">
								</select>
							</div>
							...
							<div class="col">
								...
								<div class="row">
									<div class="col">
										<div class="form-group">
											...
											<s:input path="toplamAdet" cssClass="form-control" id="toplamAdet"
									...
									<div class="col">
										<div class="form-group">
											...
											<s:input path="toplamFiyat" cssClass="form-control" id="toplamFiyat"
												type="number" required="required" />
								...
								<div class="form-group">
									<label>Lütfen Seçilen Kategoride Sahip Olduğunuz Hayvan
										Tiplerini Seçiniz</label> <b class="form-text text-primary" id="tips-info"></b>
								...
								<div class="form-footer float-right">
									<a id="back-1" href="#" class="btn btn-default">Geri</a> <a id="next-3" href="#"
										class="btn btn-primary">İleri</a>
								</div>
							</div>
						</div>
					</div>
					<div id="step-3">
						...
						<div class="form-footer float-right">
							<a id="back-2" href="#" class="btn btn-default">Geri</a> <a id="next-4" href="#"
								class="btn btn-primary">İleri</a>
						</div>
					</div>
					<div id="step-4">
						<div class="form-group">
							...
							<input id="input-fotos" name="files[]" type="file" accept="image/*" multiple>
							<b class="form-text text-danger" id="resim-error"></b>
						</div>

						<div class="form-group">
							<label for="aciklama">İlan Açıklaması</label>
							<s:textarea path="aciklama" cssClass="form-control" id="aciklama" placeholder="Açıklama"
								required="required" />
