		...
		<div class="card">
			<div class="card-header">
				<a type="button" class="btn btn-success float-right"
					href="${pageContext.request.contextPath}/user/advert/add">İlan
					Ekle</a>
						...
						<c:forEach var="a" items="${adverts}">
							<tr>
								...
								<td style="vertical-align: middle;"><a
									...
									href="${pageContext.request.contextPath}/user/advert/detail/${a.id}"><i
										class="fas fa-list mr-1"></i>Detay</a> <a
									class="btn btn-sm btn-default"
									href="${pageContext.request.contextPath}/user/photo/advert/${a.id}"><i
										class="far fa-images mr-1"></i>Photos</a><a
									class="btn btn-sm btn-warning"
									href="${pageContext.request.contextPath}/user/advert/edit/${a.id}">
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger" id="action"
												onclick="location.href='${pageContext.request.contextPath}/user/advert/delete/${a.id}'">Delete</button>
										</div>
									</div>
								</div>
							</div>
