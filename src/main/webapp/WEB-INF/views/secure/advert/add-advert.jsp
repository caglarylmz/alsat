    ...
    <form-wizard @on-complete="onComplete" shape="circle" color="orange" title="" subtitle=''>
                    ...
                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                        <div class="uk-width-auto" v-if="selectedCategory!=null">
                            <dl class="uk-description-list">
                                ...
                                <dd> <span class="uk-label uk-label-success">{{selectedCategory.name}}</span>
                                </dd>
                    ...
                    <div class="uk-width-1-2@s">
                        ...
                        <div class="uk-width-1">
                            <div class="uk-inline">
                                ...
                                <input class="uk-input" id="toplamAdet" type="number" v-model="advertPlain.toplamAdet"
                    ...
                    <div class="uk-width-1-2@s">
                        ...
                        <div class="uk-width-1">
                            <div class="uk-inline">
                                ...
                                <input class="uk-input" id="toplamFiyat" type="number" v-model="advertPlain.toplamFiyat"
        ...
        <tab-content title="Last step" icon="ti-check">
            <div class="col-12 text-center">
                <p>İlanınızla ilgili aşağıdaki bilgiler doğruysa "Devam Et" butonunu tıklayıp bir
                    sonraki aşamaya geçin.
                    Değilse "Düzenle" butonunu tıklayın.</p>
                ...
                <div class="container border border-5">
                    ...
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="col-sm-12 col-lg-4">
                            <span class="uk-text-lead text-left uk-text-bold">{{advertPlain.toplamFiyat}}</span>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center  justify-content-around">
                                        ...
                                        <label class="mr-1" uk-icon="star" style="color: red;"></label>
                                        <label class="mr-1" uk-icon="comment" style="color:#00aced;"></label>
                                        <label class="mr-1" uk-icon="whatsapp" style="color:#0dc143;"></label>
                                    </div>
                                </div>
                            </div>
                            <!--USER DETAILS-->
        ...
        <template slot="footer" slot-scope="props">
            ...
            <div class="wizard-footer-right">
                ...
                <wizard-button v-else @click.native="onComplete()" class="finish-button" :style="props.fillButtonStyle">
