        ...
        <div class="col-3">
            <div class="row align-items-center  justify-content-end">
                ...
                <div class="uk-inline">
                    ...
                    <div uk-dropdown="mode: click"> <a href="" class="uk-icon-button" uk-icon="twitter"
                            style="color: #4867aa;"></a>
                        ...
                        <a href="" class="uk-icon-button" uk-icon="whatsapp" style="color: #0dc143;"></a></div>
                </div>
            </div>
        </div>
        <!--ICONS-->
                        ...
                        <c:forEach var="photo" items="${advert.photos}">
                            <li>
                                ...
                                <c:if test="${photo.name eq 'no_image.jpg'}">
                                    <img src="${pageContext.request.contextPath}/uploads/${photo.name}" alt="" uk-cover>
                        ...
                        <c:if test="${!isFavouriteSeller}">
                            <s:form method="post" modelAttribute="advert"
                                ...
                                <a href="" type="submit" class="uk-icon-button mr-1" uk-icon="heart"
                                    uk-tooltip="title:Favori Satıcılarıma Ekle; pos:bottom" style="color: red;"></a>
                                <s:hidden path="id" />
                            </s:form>
            ...
            <ul id="my-id" class="uk-switcher uk-margin">
                <li>
                    <article class="uk-article">
                        <p class="uk-text-lead">${advert.aciklama}</p>
                    </article>
                </li>
                <li>
                    <div>
