...
<div class="container h-100" id="add-advert">
    ...
    <!--STEP-1-->
    <div class="container mt-3" v-if="isActive0 || !isSuccess0">
        <div v-if="selectedCategory==null">
            <div class="ui red message mt-2" v-if="errorMessage!=''">{{errorMessage}}</div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="ui vertical menu">
                    <a class="teal item" v-for="(item, index) in category" :key="item.id"
    ...
    <!--STEP-1-->
    <!--STEP-2-->
    <div class="container mt-3" v-if="isActive1">
        <div class="ui red message mt-2" v-if="errorMessage!=''">{{errorMessage}}</div>
        <div class="ui form">
            <div class="field">
                <label>İlan Başlığı Input</label>
                <input type="text">
            </div>
            <quill-editor ref="quillEditor" class="editor" v-model="content" :options="editorOption"
    ...
    <div class="row justify-content-end mr-3">
        <div class="small ui animated button ui secondary" tabindex="0" v-show="showBackButton" v-on:click="back">
