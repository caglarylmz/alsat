	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<div class="container-fluid" id="category-adverts">
				<div class="uk-child-width-1-1 mb-3 ml-0 border" uk-grid>
					<div>
						<div class="uk-panel py-2"><a class="uk-link-toggle" href="#">
								<span class="uk-link-heading uk-text-bold">${category.name}</span>
							</a> kategorisinde <span
								class="uk-link-heading uk-text-bold">${categoryAdverts.size()}</span> ilan bulundu.
						</div>
					</div>
							...
							<div class="uk-flex uk-column-1-2@s uk-flex-between" uk-grid>
								...
								<div class="uk-column-width-1">
									<ul class="uk-subnav uk-subnav-pill">
										...
										<li uk-filter-control="[data-color='sahibinden']"><a href="#">Sahibinden</a>
										</li>
												...
												<div class="uk-card-body p-1">
													<div class="advert-container">
														...
														<div class="advert-details p-1">
															...
															<label
																class="uk-text-danger label mb-3">${toplamFiyat}</label>
															<div class="item">
